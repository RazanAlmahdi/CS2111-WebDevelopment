    ...
    <body>
        <div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                ...
                <!-- Page content-->
                <div class="container-fluid">
                    <h1 class="mt-4">Adding a new visit</h1>
                    <p>Great, we had new visitors. please fill in the form below:</p>
					...
					<form method="post" action="addvisit.php">
						...
						<p>
							<input type="submit" value="Add visit" id="visitsubmit" name="visitsubmit">
							<input type="reset">
						</p>
