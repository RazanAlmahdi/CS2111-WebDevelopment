            ...
            <div id="page-content-wrapper">
                ...
                <div class="container-fluid">
                    <?php
						...
						$visitors = $_POST['visitornumber'];
						$visitdate = $_POST['visitdate'];
						$visitid = $_POST['visitID'];
                        
						
						$sql = "update visit set schoolID = '".$schoolid."', visitDate = '".$visitdate."', visitorsNumber= ".$visitors." where ID =".$visitid;
						//echo $sql;
						...
						{
							echo "<h3> We could not save the data. Try again later! </h3>";
						}
